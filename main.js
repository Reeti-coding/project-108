...
function startClassifictaion() {
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/lGFkJuJ7S/model.json',modelReady);
}
function modelReady() {
...
function gotResult(error, results) {
    if(error){
        ...
        random_number_g = Math.floor(Math.random() * 0) + 1;
        random_number_b = Math.floor(Math.random() * 125) + 1;
